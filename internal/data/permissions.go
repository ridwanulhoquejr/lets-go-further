...
// permissions type for this
type Permissions []string

// add a helper method to check wheather a permission is include
...
func (m PermissionModel) GetAllForUser(userId int64) (Permissions, error) {
	...
	// temp variables for storing all the code from the db
	var permissions Permissions
	for rows.Next() {

		// temp var for iteration level
